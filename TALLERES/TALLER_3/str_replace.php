...
$miFrase = "Tengo Hambre"; // Reemplaza esto con tu frase
$miFraseModificada = str_replace("Tengo", "No tengo", $miFrase);
...
// Bonus: Usa str_replace() para reemplazar múltiples palabras a la vez
$texto = "Mañana voy para la U. Me gusta ir a clases de DSVII";
$buscar = ["voy", "Me gusta"];
$reemplazar = ["NO VOY", "NO ME GUSTA"];
$textoModificado = str_replace($buscar, $reemplazar, $texto);
