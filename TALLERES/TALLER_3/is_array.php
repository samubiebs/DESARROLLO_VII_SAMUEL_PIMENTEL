...
$miArray = ["Maria", "Maria", "Maria"]; // Reemplaza esto con tu propio array
$miString = "Samuel"; // Reemplaza esto con tu propio string
$miNumero = 31; // Reemplaza esto con tu propio número
