...
$lista = ["Rey", "Edgar", "Bruno"];
echo "Lista de mis inservibles: </br> ";
print_r($lista);

array_push($lista, "Yoni", "Theo");
echo "</br> Lista despues del array push con los nombres agregados: </br>";
print_r($lista);

// Ejercicio: Crea un array con los nombres de 3 de tus amigos
// y usa array_push() para añadir 2 amigos más
$misAmigos = ["Otto", "Darrel", "Malek"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Pablo", "Chucky"); // Reemplaza las comillas vacías con los nombres de tus amigos

echo "</br>Mis Amixes :</br>";
print_r($misAmigos);
